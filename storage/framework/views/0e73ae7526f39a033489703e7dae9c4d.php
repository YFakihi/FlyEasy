...
document.addEventListener("DOMContentLoaded", function () {
    const backgrounds = [
        'url("<?php echo e(asset("images/Marrakech-Car.jpg")); ?>")', 
        'url("<?php echo e(asset("images/Marrakech-Lounge.jpg")); ?>")',
        'url("<?php echo e(asset("images/RAK-Lounge-Departures.jpg")); ?>")',
...
<section class="bg-white relative dark:bg-gray-900 w-full" id="background-slider"
style="background: url('<?php echo e(asset("images/Marrakech-Car.jpg")); ?>');"  background-size: cover; background-repeat: no-repeat; background-position: center; padding-top: 120px; padding-bottom: 120px; position: relative;">
        ...
        <div class="grid w-full px-4 py-18 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 relative z-10">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <h2 class="max-w-2xl mb-6 font-medium text-gray-200 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                    ...
                    class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-blue-900 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    Booking Now</a>
