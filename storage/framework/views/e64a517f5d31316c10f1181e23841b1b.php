...
<div x-data="auth">
    ...
    <div class="relative flex min-h-screen items-center justify-center px-6 py-10 bg-[#5bb4b8] dark:bg-[#060818] sm:px-16">

        <div
            class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-[#5bb4b8]  backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
            <div
                class="relative hidden w-full items-center justify-center bg-gradient-to-r from-[#0B2C3D] bg-[#5bb4b8]  p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-28 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                <div
                    class="absolute inset-y-0 w-8 from-primary/10 via-transparent to-transparent ltr:-right-10 ltr:bg-gradient-to-r rtl:-left-10 rtl:bg-gradient-to-l xl:w-16 ltr:xl:-right-20 rtl:xl:-left-20">
                </div>
                <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                    <a href="/" class="w-64 block lg:w-72 ms-14">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Cover Image" class="w-full" />
                    </a>
          ...
          qw
                <div class="w-full max-w-[440px] lg:mt-16">
                    ...
                    <form id="form" action="<?php echo e(route('register')); ?>" method="POST"
                        ...
                        <div class="form-control">
                            ...
                            <div class="relative text-white-dark">
                                <input id="Name" type="text" name="name" placeholder="Enter Name"
                                    class="w-full rounded-md border border-[#e0e6ed] bg-white px-4 py-2 text-sm font-semibold text-black !outline-none focus:border-blue-500 focus:ring-transparent dark:border-[#17263c] dark:bg-[#121e32] dark:text-white-dark dark:focus:border-blue-500 ps-10 placeholder:text-white-dark" />
